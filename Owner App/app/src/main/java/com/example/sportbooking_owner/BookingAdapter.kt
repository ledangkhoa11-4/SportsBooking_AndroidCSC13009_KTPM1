...
class BookingAdapter(private val context: Activity, private val bookingHistories:ArrayList<BookingHistory>) : ArrayAdapter<BookingHistory>(context,R.layout.booking_item_layout,bookingHistories){
